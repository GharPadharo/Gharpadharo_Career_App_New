...
export async function generateMetadata({ params }) {
  ...
  const canonicalUrl = `https://career.gharpadharo.com/careers/jobs/${job.id}`;
          ...
          <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-6">
            ...
            <div className="shrink-0">
              <Link
                ...
                className="w-full sm:w-auto inline-flex items-center justify-center gap-2 bg-[#3b5ae8] hover:bg-[#314bc7] text-white text-sm sm:text-base font-bold px-7 py-3.5 rounded-xl shadow-xs transition-all duration-200 active:scale-95 text-center focus:outline-none focus:ring-2 focus:ring-primary/40"
              >
                <span>Apply Now</span>
            ...
            <div className="bg-white rounded-2xl border border-slate-200/80 p-6 shadow-xs lg:sticky lg:top-24 space-y-6">
              ...
              <div className="pt-2 space-y-3">
                <Link
                  href={`/careers/jobs/${job.id}/apply`}
                  aria-label={`Apply for ${job.title}`}
                  className="w-full inline-flex items-center justify-center gap-1.5 bg-[#3b5ae8] hover:bg-[#314bc7] text-white text-sm font-bold px-5 py-3 rounded-xl shadow-xs transition-all duration-200 text-center active:scale-95 focus:outline-none focus:ring-2 focus:ring-primary/40"
                >
                  <span>Apply Now</span>
                  <span aria-hidden="true">&rarr;</span>
                </Link>
